...
$aksi="modul/mod_invoicebooking/invoicebooking_aksi.php";
    ...
    <div class="row">
      <div class="col-sm-12 col-md-12">
        <div class="block-flat">
          <div class="content">
            <!-- ========== Button ========== -->
            <form method="get" action='<?php echo '?module=invoicebooking&'.$_SERVER['PHP_SELF'] ?>'>
              <div class='btn-navigation'>
                <div class='pull-right'>
                  <a class="btn btn-primary" href="?module=invoicebooking"><i class="fa fa-times-circle"></i> Bersihkan Pencarian</a>
                </div>
              </div>
              <div class='row'>
                <div class='btn-search'>Cari Berdasarkan Order ID :</div>
                  <div class='col-md-3 col-sm-12'>
                    <div class="input-group">
                      <input type=hidden name=module value=invoicebooking>
              ...
              <div class="table-responsive">
                <table class="hover">
                  ...
                  if (empty(isset($_GET['kata']))) {
                    ...
                    $result=mysqli_query($connect,"SELECT * FROM invoice WHERE invoice_status='booking' LIMIT $posisi,$batas");
                    $jmldata = mysqli_num_rows(mysqli_query($connect,"SELECT * FROM invoice WHERE invoice_status='booking'"));
                    ...
                    ?>
                    <tr>
                    <td class="center" rowspan="2"><?php echo $r['invoice_id'] ?></td>
                                                <td class="center">
                    ...
                    <td>
                    Total Ruangan: <?php echo $r['invoice_qty'] ?><br>
Total Harga: Rp<?php echo format_rupiah($r['invoice_price']) ?>,00<br>
Booking Harga: Rp<?php echo format_rupiah($r['invoice_price'] * (20/100)) ?>,00
</td>
                      ...
                      <td align="center">
                        ...
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu pull-right" role="menu">
                            <li>
                              <a href="javascript:;" data-id="<?php echo $r['invoice_id'] ?>" data-toggle="modal" data-target="#modal-konfirmasi" title="Accept <?php echo $r['invoice_id'] ?>"><i class='fa fa-check'></i> Accept</a>
                            </li>
                            <li>
                              <a href="?module=invoicebooking&act=cancel&id=<?php echo $r['invoice_id'] ?>" title="Cancel <?php echo $r['invoice_id'] ?>"><i class='fa fa-close'></i> Cancel</a>
                            </li>
                            <li>
                              <a href="?module=invoicebooking&act=detail&id=<?php echo $r['invoice_id'] ?>" title="Detail <?php echo $r['invoice_id'] ?>"><i class='fa fa-eye'></i> Detail</a>
                            </li>
                          </ul>
                        </div>
                ...
                <?php } else {
                  ...
                  $result=mysqli_query($connect,"SELECT * FROM invoice WHERE invoice_id LIKE '%$search%' AND invoice_status='booking' LIMIT $posisi,$batas");
                  if(mysqli_num_rows($result) === 0) {
                  $jmldata = mysqli_num_rows(mysqli_query($connect,"SELECT * FROM invoice WHERE invoice_id LIKE '%$search%' AND invoice_status='booking'"));
                  ?>
                  <tr>
                    <td class="center" colspan="10">Data kosong...</td>
                  </tr>
  ...
  <div class="cl-mcont">
    <div class="row">
      <div class="col-md-12">
        <div class="block-flat">
          <div class="content">
            <form role="form" class="form-horizontal" action="<?php echo $aksi ?>?module=invoicebooking&act=cancel" method="post" enctype="multipart/form-data" parsley-validate novalidate>
          ...
          <div class='center'>
            ...
            <input class="btn btn-default" type="reset" name="batal" value="Batalkan" onclick="location.href='?module=invoicebooking'"/>
          </div>
            </form>
        </div>
      </div>
          ...
          <div class="content">
              ...
              <div class="table-responsive">
                <table class="hover">
                  ...
                  <tbody>
                  <?php
                    $result=mysqli_query($connect,"SELECT * FROM invoice WHERE invoice_status='booking' AND invoice_id='$_GET[id]'");
                    $jmldata = mysqli_num_rows(mysqli_query($connect,"SELECT * FROM invoice WHERE invoice_status='booking' AND invoice_id='$_GET[id]'"));
                    if(mysqli_num_rows($result) === 0) {
                    ?>
                    <tr>
                      <td class="center" colspan="10">Data kosong...</td>
              ...
              <div class="table-responsive">
                <table class="hover">
                  ...
                  <?php
                    ...
                    $result=mysqli_query($connect,"SELECT * FROM transaction WHERE transaction_status='booking' AND invoice_id='$_GET[id]' LIMIT $posisi,$batas");
                    $jmldata = mysqli_num_rows(mysqli_query($connect,"SELECT * FROM transaction WHERE transaction_status='booking' AND invoice_id='$_GET[id]'"));
                    if(mysqli_num_rows($result) === 0) {
                    ?>
                    <tr>
                      <td class="center" colspan="10">Data kosong...</td>
                    ...
                    <td class='text-center'><?php echo $r['transaction_qty'] ?> Ruangan</td>
...
<?php echo tgl_indo($r['transaction_day']) ?> Hari</td>
              ...
              <input class="btn btn-default" type="reset" name="batal" value="Kembali" onclick="location.href='?module=invoicebooking'"/>
            </div>
          </div>
        </div>
      </div>
