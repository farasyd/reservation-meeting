...
$aksi="modul/mod_invoicecancel/invoicecancel_aksi.php";
    ...
    <div class="row">
      <div class="col-sm-12 col-md-12">
        <div class="block-flat">
          <div class="content">
            <!-- ========== Button ========== -->
            <form method="get" action='<?php echo '?module=invoicecancel&'.$_SERVER['PHP_SELF'] ?>'>
              <div class='btn-navigation'>
                <div class='pull-right'>
                  <a class="btn btn-primary" href="?module=invoicecancel"><i class="fa fa-times-circle"></i> Bersihkan Pencarian</a>
                </div>
              </div>
              <div class='row'>
                      ...
                      <td align="center">
                        ...
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu pull-right" role="menu">
                            <li>
                              <a href="?module=invoicecancel&act=detail&id=<?php echo $r['invoice_id'] ?>" title="Detail <?php echo $r['invoice_id'] ?>"><i class='fa fa-eye'></i> Detail</a>
                            </li>
                          </ul>
                        </div>
  ...
  <div class="cl-mcont">
    <div class="row">
      <div class="col-md-12">
        <div class="block-flat">
          <div class="content">
            <form role="form" class="form-horizontal" action="<?php echo $aksi ?>?module=invoicecancel&act=cancel" method="post" enctype="multipart/form-data" parsley-validate novalidate>
          ...
          <div class='center'>
            ...
            <input class="btn btn-default" type="reset" name="batal" value="Batalkan" onclick="location.href='?module=invoicecancel'"/>
          </div>
            </form>
        </div>
      </div>
          ...
          <div class="content">
              ...
              <div class="table-responsive">
                <table class="hover">
                  ...
                  <tbody>
                  <?php
                    $result=mysqli_query($connect,"SELECT * FROM invoice WHERE invoice_status='cancel' AND invoice_id='$_GET[id]'");
                    $jmldata = mysqli_num_rows(mysqli_query($connect,"SELECT * FROM invoice WHERE invoice_status='cancel' AND invoice_id='$_GET[id]'"));
                    if(mysqli_num_rows($result) === 0) {
                    ?>
                    <tr>
                      <td class="center" colspan="10">Data kosong...</td>
              ...
              <div class="table-responsive">
                <table class="hover">
                  ...
                  <?php
                    ...
                    $result=mysqli_query($connect,"SELECT * FROM transaction WHERE transaction_status='cancel' AND invoice_id='$_GET[id]' LIMIT $posisi,$batas");
                    $jmldata = mysqli_num_rows(mysqli_query($connect,"SELECT * FROM transaction WHERE transaction_status='cancel' AND invoice_id='$_GET[id]'"));
                    if(mysqli_num_rows($result) === 0) {
                    ?>
                    <tr>
                      <td class="center" colspan="10">Data kosong...</td>
...
<?php echo tgl_indo($r['transaction_day']) ?> Hari</td>
              ...
              <input class="btn btn-default" type="reset" name="batal" value="Kembali" onclick="location.href='?module=invoicecancel'"/>
            </div>
          </div>
        </div>
      </div>
